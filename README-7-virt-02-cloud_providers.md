...
root@dev1-10:~/netol_do/yc2/terraform# terraform init
...
root@dev1-10:~/netol_do/yc2/terraform# 
...
root@dev1-10:~/netol_do/yc2/terraform# terraform plan
...
>  Amazon AMI – это поддерживаемый и обслуживаемый образ Amazon Web Services, которые уже и не поддерживвается, и теперь менее актуальны, к сожалению.
